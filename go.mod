...
require (
	...
	go.opentelemetry.io/proto/slim/otlp/collector/profiles/v1development v0.3.0 // indirect
	go.opentelemetry.io/proto/slim/otlp/profiles/v1development v0.3.0 // indirect
